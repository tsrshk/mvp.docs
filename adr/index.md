...
| [[ADR-023]] | RBAC 3 роли (superadmin/admin/manager) + org-level membership + user-management API | accepted | 2026-07-21 |
| [[ADR-024]] | Второй ERP-шов активирован — QuickResto как санкционированная вторая реализация (частично вытесняет ADR-009) | accepted | 2026-07-21 |
...
## Changelog
- 2026-07-21 v1.8.0 — добавлен [[ADR-024]] (второй ERP-шов активирован: QuickResto как санкционированная вторая реализация, выбор пер-организацию; частично вытесняет [[ADR-009]] для ERP-шва; инвариант одной OCR-реализации сохранён). Устранён дрейф код↔ADR (код-ревью 2026-07-21, L-5).
- 2026-07-21 v1.7.0 — добавлен [[ADR-023]] (RBAC 3 роли superadmin/admin/manager, org-level membership с nullable subdivision, user-management API). Устранён долг: реестр отставал от уже принятого ADR-023 (код-ревью 2026-07-21, L-18).
